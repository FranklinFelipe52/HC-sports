                ...
                <div role="row" class="pr-12 grid grid-cols-12 border-b border-b-gray-5 last:border-b-0">
                  <div role="cell" class="col-span-2 lg:col-span-1 py-3 flex justify-center items-center ">
                    <div class="h-[24px] w-[24px]">
                      <img src="/inscricao/images/svg/modalidades/modalidade-{{ $modalidade->id }}.svg" alt="" class="h-full w-full object-cover">
                    </div>
                  </div>
                  ...
                  <div role="cell" class="col-span-1 lg:col-span-3 py-3 flex gap-2 justify-end items-center">
                    <a href="/inscricao/admin/modalidade/{{ $modalidade->id }}" class="w-[34px] h-[34px] hover:bg-fill-base hover:ring-2 hover:ring-fill-base rounded-full transition">
