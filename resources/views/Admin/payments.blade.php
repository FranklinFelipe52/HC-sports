            ...
            <div role="row" class="border-b border-gray-5 last:border-b-0">
              <div class="grid grid-cols-12 px-6 pt-4 pb-2.5">
                ...
                <div role="cell" class="col-span-2 flex justify-end">
                  <a href="/admin/pagamentos/confirm/{{ $payment->id }}" data-tooltip-payment class="block w-[24px] h-[24px] hover:bg-fill-base hover:ring-2 hover:ring-fill-base rounded-full transition">
