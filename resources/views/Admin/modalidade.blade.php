                ...
                <div class="bg-white mx-3 overflow-hidden rounded-lg w-full max-w-[550px]">
                    ...
                    <div class="bg-gray-6 p-3 md:pr-6 md:pl-5 md:py-4 flex">
                        ...
                        <button data-modalId="modal{{ $registration->id }}" data-action="close"
                            ...
                            <img src="/inscricao/images/svg/close.svg" class="w-full h-full object-cover" alt="">
                        </button>
                    </div>
            ...
            <div class="flex h-screen w-full fixed bottom-0 bg-black bg-opacity-60 z-50 justify-center items-center">
                <div class="bg-white mx-3 p-3 md:p-6 rounded-lg w-full max-w-[500px]">
                    ...
                    <div class="flex justify-end gap-4 flex-wrap mt-10">
                        <a href="/inscricao/admin/registration/delete/{{ $registration->id }}"
                        ...
                        <button data-modalId="modal-excluir-inscricao-{{ $registration->id }}" data-action="close"
                            class="bg-black border border-black text-white text-sm font-poppins font-bold w-full sm:w-fit py-2.5 px-4 rounded flex justify-center items-center gap-2.5 hover:ring-2 hover:ring-black hover:ring-opacity-50 transition disabled:opacity-50 disabled:hover:ring-0">
                            Cancelar
                        </button>
                    </div>
                </div>
    ...
    <div
        ...
        <div class="order-1 sm:order-2 overflow-hidden flex flex-col">
            ...
            <div class="hidden bg-brand-a1 py-2 px-4 lg:px-6">
                <div class="flex">
                    <button
                        class="text-xs font-poppins text-white border border-white py-0.5 px-2 ml-auto hover:ring-1 hover:ring-white hover:ring-opacity-50 transition">
            ...
            <div class="h-full w-full overflow-hidden flex flex-col">
                ...
                <header class="pt-8 pb-6 space-y-6">
                    <div class="container">
                        <nav aria-label="Breadcrumb" class="flex items-center flex-wrap gap-2 mb-6">
                            <div>
                                <a href="/inscricao/admin/modalidades" class="text-xs text-gray-1 block hover:underline">
                                    Modalidades
                                </a>
                            </div>
                    ...
                    <div class="md:col-span-4 lg:col-span-3">
                        <div
                            ...
                            <div class="w-[80px] h-[80px] sm:w-[100px] sm:h-[100px] rounded-full md:mx-auto shrink-0">
                                <img src="/inscricao/images/svg/modalidades/modalidade-{{ $modalidade->id }}.svg"
                            ...
                            <div class="flex gap-2 sm:gap-8 flex-wrap md:block md:space-y-6">
                                <div>
                                    ...
                                    <div
                                        class="@if ($modalidade->modalities_type->id == 1) bg-feedback-fill-blue  @else bg-feedback-fill-purple @endif py-1 px-1.5 rounded-full inline-block w-fit h-fit">

                                        <p
                                            class=" @if ($modalidade->modalities_type->id == 1) text-brand-a1  @else text-feedback-purple @endif     text-sm">
              ...
              <div class="flex md:flex-col gap-4 md:gap-0">
                <a href="/inscricao/src/pages/admin/modalidade-categorias.html" class="text-brand-a1 underline text-sm block">
                  Exibir categorias
                </a>

                <hr class="hidden md:block border-gray-5 my-5">

                <a href="/inscricao/src/pages/admin/modalidade-relatorio.html" class="text-brand-a1 underline text-sm block">
                  Ver relatório
                </a>
              </div> --}}
                        </div>
                        @if (Session('admin')->rule->id == 1)
                            @if ($modalidade->id == 9 || $modalidade->id == 10)
                                <div class="flex flex-col gap-3">
                                    <button 
                                        onclick="window.open('/admin/registration/create/{{ $modalidade->id }}?gender=M', '_self')"
                                        class="h-fit flex items-center justify-center gap-4 w-full px-4 py-2.5 rounded border-[1.5px] border-brand-a1  hover:ring-2 hover:ring-brand-a1 hover:ring-opacity-50 bg-brand-a1  transition">
                                        <p class="text-white text-sm font-bold font-poppins">
                                            Adicionar atleta masculino
                                        </p>
                                    </button>
                                    <button 
                                        onclick="window.open('/admin/registration/create/{{ $modalidade->id }}?gender=F', '_self')"
                                        class="h-fit flex items-center justify-center gap-4 w-full px-4 py-2.5 rounded border-[1.5px] border-brand-a1  hover:ring-2 hover:ring-brand-a1 hover:ring-opacity-50 bg-brand-a1  transition">
                                        <p class="text-white text-sm font-bold font-poppins">
                            ...
                            @else
                                <button 
                                    onclick="window.open('/admin/registration/create/{{ $modalidade->id }}', '_self')"
                                    class="h-fit flex items-center justify-center gap-4 w-full px-4 py-2.5 rounded border-[1.5px] border-brand-a1  hover:ring-2 hover:ring-brand-a1 hover:ring-opacity-50 bg-brand-a1  transition">
                                    <p class="text-white text-sm font-bold font-poppins">
                                        Adicionar atleta
                                    </p>
                        ...
                        @else
                            @if ($modalidade->id == 9 || $modalidade->id == 10)
                                <div class="flex flex-col gap-3">
                                    <button disabled
                                        onclick="window.open('/admin/registration/create/{{ $modalidade->id }}?gender=M', '_self')"
                                        class="h-fit flex items-center justify-center gap-4 w-full px-4 py-2.5 rounded border-[1.5px]   hover:ring-2 hover:ring-brand-a1 hover:ring-opacity-50 bg-brand-a1 bg-opacity-60  transition">
                                        <p class="text-white text-sm font-bold font-poppins">
                                            Adicionar atleta masculino
                                        </p>
                                    </button>
                            ...
                            @endif
                        @endif
                        {{-- <a href="/inscricao/src/pages/admin/modalidade-cadastrar-categoria.html" class="h-fit flex items-center justify-center gap-4 w-full px-4 py-2.5 rounded-md border-[1.5px] border-brand-a1 hover:ring-2 hover:ring-brand-a1 hover:ring-opacity-50 transition">
                                ...
                                <div class="border border-t-0 rounded-b-lg space-y-3 pt-3">
                                    ...
                                    @if (Count($registrations) != 0)
                                        @foreach ($federative_units as $federative_unit)
                                            {{-- Accordion --}}
                                            <div class="group border-b last:border-0 border-gray-200"
                                                id="uf-{{ $federative_unit->code }}-registrations-accordion"
                                                data-accordion="accordion">
                                                <button data-accordion="button"
                                                    class="group-[.active]:bg-fill-base py-2 w-full hover:bg-fill-base transition-all flex justify-between items-center px-2"
                                                    data-accordion="header"
                                                    data-accordion-id="uf-{{ $federative_unit->code }}-registrations-accordion">
                                                    <p class="text-gray-1 font-semibold text-start">
                                                        Atletas {{ $federative_unit->name }} -
                                                        {{ $federative_unit->initials }}
                                                    </p>
                                                    <div class="group-[.active]:hidden">
                                                        <img src="/inscricao/images/svg/accordion-arrow.svg"
                                                            class="group-hover:hidden" alt="">
                                                        <img src="/inscricao/images/svg/accordion-arrow-active.svg"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="flex gap-2 grow">
                                                                    <div class="grow space-y-1">
                                                                        <a href="/inscricao/admin/users/{{ $registration->user->id }}"
                                                                ...
                                                                <div
                                                                    class="flex sm:items-end justify-between gap-1.5 grow sm:grow-0 mt-1 sm:mt-0">
                                                                    @if ($registration->status_regitration->id == 1)
                                                                        <div
                                                                            class=" bg-feedback-fill-green py-1 px-1.5 rounded-full inline-block w-fit h-fit">
                                                                    ...
                                                                    @elseif ($registration->status_regitration->id == 3)
                                                                        <div
                                                                            class="bg-feedback-fill-purple py-1 px-1.5 rounded-full inline-block min-w-[148px] w-fit h-fit">
                                                                    ...
                                                                    <div class="flex flex-nowrap gap-2">
                                                                        <button
                                                                            data-modalId="modal{{ $registration->id }}"
                                                                            data-action="open"
                                                                        ...
                                                                        @if (!($registration->type_payment_id == 2 && $registration->status_regitration_id == 1))
                                                                            @if ($modalidade->id == 9 || $modalidade->id == 10)
                                                                                <a href="/inscricao/admin/registration/update/{{ $registration->id }}?gender={{ $registration->user->sexo }}"
                                                                                    class="h-fit text-[10px] font-poppins font-normal text-gray-1 grow px-[8px] py-[2px] rounded-md border border-gray-2 hover:ring-1 hover:ring-gray-2 hover:ring-opacity-50 disabled:hover:ring-0 disabled:opacity-50 disabled:cursor-not-allowed transition">
                                                                                    Editar
                                                                                </a>
                                                                            @else
                                                                                <a href="/inscricao/admin/registration/update/{{ $registration->id }}"
                                                                                    class="h-fit text-[10px] font-poppins font-normal text-gray-1 grow px-[8px] py-[2px] rounded-md border border-gray-2 hover:ring-1 hover:ring-gray-2 hover:ring-opacity-50 disabled:hover:ring-0 disabled:opacity-50 disabled:cursor-not-allowed transition">
                                                                                    Editar
                                                                                </a>
                                                                            @endif
                                                ...
                                                <div class="px-2 flex justify-end w-full hidden" data-accordion="footer">
                                                    <button class="py-2 rotate-180 transition-all" data-accordion="button"
                                                        data-accordion-id="uf-{{ $federative_unit->code }}-registrations-accordion">
                                                        <img src="/inscricao/images/svg/accordion-arrow-active.svg" class=""
                                                            alt="">
                                                    </button>
                                                </div>
                                            </div>
                                ...
                                <div class="border border-t-0 rounded-b-lg space-y-6">
                                    ...
                                    @if (Count($registrations) != 0)
                                        @foreach ($registrations as $registration)
                                            <!-- inscrição -->
                                            <div
                                                class="flex items-end flex-wrap md:flex-nowrap justify-end gap-2 border-b border-gray-200 w-full last:border-b-0 px-4 py-3 bg-white hover:bg-fill-base transition cursor-default last:rounded-b-md">
                                                <div class="flex gap-2 grow">
                                                    <div
                                                        class="flex-shrink-0 w-[37px] h-[37px] overflow-hidden min-[360px]:block">
                                                        <img src="/inscricao/images/svg/user-circle.svg"
                                                            class="w-full h-full object-cover" alt="">
                                                    </div>
                                                    <div class="grow space-y-1">
                                                        <a href="/inscricao/admin/users/{{ $registration->user->id }}"
                                                ...
                                                <div
                                                    class="flex sm:flex-col sm:items-end justify-between gap-1.5 grow sm:grow-0 mt-1 sm:mt-0">
                                                    @if ($registration->status_regitration->id == 1)
                                                        <div
                                                            class=" bg-feedback-fill-green py-1 px-1.5 rounded-full inline-block w-fit h-fit">
                                                            <p class="text-feedback-green-1 text-xs">
                                                    ...
                                                    @endif
                                                    <div class="flex flex-nowrap gap-2">
                                                        <button data-modalId="modal{{ $registration->id }}"
                                                            data-action="open"
                                                            class="h-fit text-[10px] font-poppins font-normal text-gray-1 grow px-[8px] py-[2px] rounded-md border border-gray-2 hover:ring-1 hover:ring-gray-2 hover:ring-opacity-50 disabled:hover:ring-0 disabled:opacity-50 disabled:cursor-not-allowed transition">
                                                            Detalhes
                                                        </button>
