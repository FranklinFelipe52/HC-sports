      ...
      <div class="px-6 h-full w-full flex flex-col overflow-hidden">
        ...
        <header class="pt-8 pb-6">
          <nav aria-label="Breadcrumb" class="flex items-center flex-wrap gap-2 mb-6">
            ...
            @else
              <div>
                <a target="_self" href="/admin/logs" class="text-xs text-gray-1 block hover:underline">
                  LOGs
                </a>
              </div>
            @endif
          ...
          <div class="h-fit flex flex-col overflow-y-hidden overflow-x-auto" role="table">
            ...
            <div class="border-x border-b border-gray-5 min-w-[600px]" role="heading">
              <div role="row" class="grid grid-cols-12 px-4 py-3">
                <div role="columnheader" class="text-start col-span-4 xl:col-span-2">
                ...
                <div role="columnheader" class="text-start col-span-2 xl:col-span-3">
                  <p class="text-sm font-semibold text-gray-1 ">
                    Autor
                  </p>
                </div>
                <div role="columnheader" class="text-start col-span-3 xl:col-span-4">
                  <p class="text-sm font-semibold text-gray-1 ">
                    Descrição
                  </p>
                </div>
                ...
                @foreach ($logs as $log)
                  ...
                  <div role="row" class="px-4 grid grid-cols-12 border-b border-b-gray-5 last:border-b-0" data-pagination-item>
                    ...
                    <div role="cell" class="py-3 flex items-center col-span-2 xl:col-span-3">
                      <a target="_self" class="hover:underline" href="/admin/logs/{{ $log->admin->id }}">
                        <p class="text-sm font-semibold text-gray-2">
