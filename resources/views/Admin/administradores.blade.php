        ...
        <header class="pt-8 pb-6 justify-between flex flex-wrap gap-6">
          ...
          @if (Session('admin')->rule->id == 1)
            <div class="flex items-center justify-center sm:justify-start gap-4 ">
              <a target="_self" role="button" href="/admin/logs" class="ml-auto px-4 py-2 w-fit rounded-lg border-[1.5px] border-brand-a1 hover:ring-2 hover:ring-brand-a1 hover:ring-opacity-50 bg-white transition">
                <img src="{{asset('/images/svg/logs.svg')}}" alt="">
              </a>
              <a target="_self" role="button" href="/admin/administradores/create" class="ml-auto px-4 py-2.5 w-fit rounded-lg border-[1.5px] border-brand-a1 hover:ring-2 hover:ring-brand-a1 hover:ring-opacity-50 bg-brand-a1 transition">
                ...
                @foreach ($administradores as $administrador)
                  ...
                  <div role="row" class="px-4 grid grid-cols-12 border-b border-b-gray-5 last:border-b-0" data-pagination-item>
                    ...
                    <div role="cell" class="py-3 flex gap-2 justify-end items-center col-span-2">
                      ...
                      <a target="_self" href="/admin/administradores/{{ $administrador->id }}" class="w-[34px] h-[34px] hover:bg-fill-base hover:ring-2 hover:ring-fill-base rounded-full transition">
