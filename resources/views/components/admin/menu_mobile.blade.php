<div id="menu-mobile" class="hidden absolute top-0 bg-white w-screen h-screen z-50 p-6 flex flex-col-reverse">
  <div class="flex justify-between">
    ...
    <button data-button="toggle-menu" data-menuId="menu-mobile" class="flex items-center justify-center lg:justify-normal gap-2 lg:px-3 py-2 group-[.active]:bg-gray-6 group-hover:bg-gray-6 rounded-lg transition px-2">
      <img src="{{asset('/images/svg/close.svg')}}" alt="Ícone do menu">
    </button>
  </div>
  <div class="flex flex-col gap-4 items-center grow justify-center">
    @if (Session('admin')->rule->id == 1)
      <div class="group @if ($type == 6) active @endif">
        <a target="_self" href="/admin/pagamentos" title="Dashboard" class="w-fit flex items-center justify-center lg:justify-normal gap-2 lg:px-3 py-2 group-[.active]:bg-gray-6 group-hover:bg-gray-6 rounded-lg transition px-2">
    ...
    @endif
    @if (Session('admin')->rule->id == 1)
      <a  target="_blank" href="/admin/report_registrations" class="w-fit flex items-center gap-2 px-3 py-2 group-[.active]:bg-gray-6 hover:bg-gray-6 rounded-lg transition mb-4">
        <div class="w-[24px] h-[24px]">
    ...
    <a target="_self" href="{{route('logout_admin')}}" title="Sair" class="w-fit flex items-center gap-2 px-3 py-2 group-[.active]:bg-gray-6 hover:bg-gray-6 rounded-lg transition">
      <div class="w-[24px] h-[24px]">
