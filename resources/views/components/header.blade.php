<div class="absolute w-full bg-white h-full z-40 flex flex-col sm:px-4 sm:pt-6 sm:pb-8">
  ...
  <nav class="my-auto">
    <ul class="flex justify-around sm:flex-col sm:gap-5">
      ...
      <li class="group sm:hidden">
        <a href="/inscricao/profile" title="Perfil" class="flex items-center justify-center lg:justify-normal gap-2 lg:px-3 py-2 group-[.active]:bg-gray-6 group-hover:bg-gray-6 rounded-lg transition px-2">
          <div class="w-[24px] h-[24px]">
  ...
  <div class="group active hidden sm:flex items-end justify-center lg:justify-start grow">
    <a href="/inscricao/profile/update" class="w-full flex justify-center lg:justify-start items-center gap-2 lg:px-3 py-2 group-[.active]:bg-gray-6 hover:bg-gray-6 rounded-lg transition">
