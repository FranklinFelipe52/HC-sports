                        ...
                        <tr>
                          <td align="center" valign="top" style="padding:0;Margin:0;width:600px">
                            <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#ffffff;background-image:url({{asset('/frontend/dist/email/images/background_1.png')}});background-repeat:no-repeat;background-position:center top" background="{{asset('/frontend/dist/email/images/background_1.png')}}" role="presentation">
                              <tr>
                                <td align="center" style="Margin:0;padding-top:15px;padding-bottom:15px;padding-left:20px;padding-right:20px;font-size:0px"><img src="{{asset('/images/PRF/Logo-Meia-PRF.png')}}" alt="Logo - Meia Maratona da PRF" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;font-size:12px" height="60" title="Logo da PRF"></td>
                              </tr>
                              <tr>
                                ...
                                <td style="padding:0;Margin:0;padding-bottom:30px">
                                  <div style="font-size:14px;font-weight:400;color:#333333;font-family:'Open sans'">
                                    ...
                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                      O email é atualizado quando o usuário solicita ao administrador. Caso não tenha solicitado essa alteração, entre em contato conosco através do formulário no nosso site. <a target="_self" href="https://www.meiamaratonaprf191.com.br/#Contato">https://www.meiamaratonaprf191.com.br/#Contato</a>
                                    </p>
                                  </div>
                                </td>
                              </tr>
