          ...
          <form class="">
            <div class="step w-full max-w-[600px]" id="step1">
                ...
                <div class="pl-4">
                  ...
                  <div class="flex items-center gap-2 mb-2">
                    ...
                    <label for="radio_input_1" class="text-gray-2 flex items-center gap-2">
                      <img src="/inscricao/images/svg/credit-card.svg" alt="">
                      Cartão de Crédito
                    </label>
                  </div>
                  ...
                  <div class="flex items-center gap-2 mb-2">
                    ...
                    <label for="radio_input_2" class="text-gray-2 flex items-center gap-2">
                      <img src="/inscricao/images/svg/pix.svg" alt="">
                      Pix
                    </label>
                  </div>
                </div>
              ...
              <div class="flex flex-wrap-reverse gap-y-6 justify-between">
                <a href="/inscricao/dashboard" class="flex items-center justify-center sm:justify-start gap-4 w-full sm:w-fit rounded-lg bg-white transition">
                  <p class="text-gray-1 underline text-sm font-normal font-poppins">
                    Cancelar
                  </p>
                </a>

                <a href="/inscricao/src/pages/atleta/pagamento-cartao.html" class="flex items-center justify-center sm:justify-start gap-4 w-full sm:w-fit px-4 py-2.5 rounded-lg border-[1.5px] border-brand-a1 hover:ring-2 hover:ring-brand-a1 hover:ring-opacity-50 bg-brand-a1 transition">
