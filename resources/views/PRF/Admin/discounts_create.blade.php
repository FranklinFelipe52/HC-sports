            ...
            <div class="w-full max-w-[230px] mb-6">
              ...
              <div class="group relative">
                ...
                <div class="absolute inset-y-0 right-0 flex items-center px-2 pointer-events-none">
                  <img src="{{asset('/images/PRF/svg/chevron-down.svg')}}" class="group-[.disabled]:hidden" alt="" />
                  <img src="{{asset('/images/svg/chevron-down-gray.svg')}}" class="hidden group-[.disabled]:block" alt="" />
                </div>
              </div>
            </div>
