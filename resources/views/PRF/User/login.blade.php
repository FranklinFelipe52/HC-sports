...
@section('content')
  ...
  <div class="lg:grid lg:grid-cols-7 xl:container">
    <div class="lg:sticky lg:top-0 lg:h-screen max-h-[1100px] lg:col-span-3 bg-white bg-prf bg-cover bg-no-repeat">
      ...
      <div class="mx-auto w-full max-w-[327px]">
        <form id="cadastro_formulario" method="post" class="mb-4">
          ...
          <div class="space-y-4 mb-6">
            ...
            <div>
              <a target="_self" href="{{route('forgot_password_get')}}" class="block pb-1 text-sm font-normal text-brand-prfA1 underline">
                Esqueci minha senha
              </a>
            </div>
          </div>
