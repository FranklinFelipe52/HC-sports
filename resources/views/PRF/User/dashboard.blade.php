                            ...
                            <div class="border border-gray-5 px-3.5 py-4 rounded-lg">
                                <div class="flex flex-wrap justify-between border-b border-gray-5 mb-4">
                                    <div class="mb-3.5 flex items-center flex-wrap gap-2">
                                        ...
                                        <div
                                            class="@if ($registration['status_registration']->id == 1) bg-feedback-green-1 @elseif ($registration['status_registration']->id == 3) bg-brand-prfA1 @endif  py-0.5 px-2 rounded-full inline-block w-fit h-fit">
                                    ...
                                    <div class="">
                                        <p
                                            class="@if ($registration['status_registration']->id == 1) text-feedback-green-1 @elseif ($registration['status_registration']->id == 3) text-brand-v1 @endif font-bold text-1.5xl w-full text-end">
                                            <span class="text-sm">
                                                R$
                                            </span>
                                ...
                                <div>
                                  ...
                                  @else
                                    <form action="/registration/{{ $registration['id'] }}/vauchers/store" method="post">
                                      @csrf
                                        <input required class="border" type="text" name="vaucher">
                    ...
                    <img src="/images/PRF/svg/chevron-left.svg" alt="">
                                    ...
                                    @if ($registration['status_registration']->id != 1)
                                        <a href="/registration/{{ $registration['id'] }}"
                                            class="bg-brand-prfA1 hover:ring-opacity-50 rounded-md hover:ring-2 transition-all hover:ring-brand-prfA1 text-sm font-poppins font-medium text-white flex items-center justify-center gap-2 py-2.5 px-3.5 w-full max-w-[220px]">
                                            Realizar Pagamento
