      ...
      <div class="mx-auto w-full max-w-[327px]">
        <form method="post" id="cadastro_formulario">
          ...
          <p class="text-sm text-gray-1 mb-8">
            Aceito a POLÍTICA DE TRATAMENTO DE DADOS, nos limites das finalidades institucionais do CORPO DE BOMBEIROS MILITAR DO RN, organizador do evento, observando o norteamento jurídico da Lei 13.709/2018 (Lei Geral de Proteção de Dados – LGPD).
          </p>
