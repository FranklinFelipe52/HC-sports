...
@section('title', 'Complete sua inscrição - SEMINÁRIO DE SAÚDE MENTAL E PREVENÇÃO DO SUICÍDIO')
      ...
      <div class="mx-auto w-full max-w-[327px]">
        <form method="post" id="cadastro_formulario">
          ...
          <p class="text-sm text-gray-1 mb-8">
            “Aceito as regras de participação da SEMINÁRIO DE SAÚDE MENTAL E PREVENÇÃO DO SUICÍDIO 191 -
