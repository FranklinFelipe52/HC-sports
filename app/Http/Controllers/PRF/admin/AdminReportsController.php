    ...
    public function all_users_get()
    {
        try {
            ...
            foreach ($users as $value) {
                if (count($value->registrations) > 0) {
                    ...
                    $user = [
                        ...
                        'Rua' => mb_convert_encoding(mb_strtoupper($value->caern_address->rua, 'UTF-8'), 'ISO-8859-1', "UTF-8"),
                        'Número' => mb_convert_encoding(mb_strtoupper($value->caern_address->number, 'UTF-8'), 'ISO-8859-1', "UTF-8"),
                        'Cidade' => mb_convert_encoding(mb_strtoupper($value->caern_address->cidade, 'UTF-8'), 'ISO-8859-1', "UTF-8"),
                        'Estado' => mb_convert_encoding(mb_strtoupper($value->caern_address->federativeUnit->initials, 'UTF-8'), 'ISO-8859-1', "UTF-8"),
                        'Complemento' => mb_convert_encoding(mb_strtoupper($value->caern_address->complemento ?? '', 'UTF-8'), 'ISO-8859-1', "UTF-8"),
            ...
            $cabecalho = [
                ...
                mb_convert_encoding(mb_strtoupper('Rua', 'UTF-8'), 'ISO-8859-1', "UTF-8"),
                mb_convert_encoding(mb_strtoupper('Número', 'UTF-8'), 'ISO-8859-1', "UTF-8"),
                ...
                mb_convert_encoding(mb_strtoupper('Complemento', 'UTF-8'), 'ISO-8859-1', "UTF-8"),
